...
To update the database use this command from the Web project folder (replace `StoryTeller` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../StoryTeller.Infrastructure/StoryTeller.Infrastructure.csproj -s StoryTeller.Web.csproj
```
